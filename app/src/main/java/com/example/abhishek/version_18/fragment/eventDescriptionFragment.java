...
public class eventDescriptionFragment extends Fragment {
     ...
     * @return A new instance of fragment eventDescriptionFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static eventDescriptionFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(bundle!=null){
            ImageView e=(ImageView)view.findViewById(R.id.event_logo);
            Resources res = getResources();
            String mDrawableName = bundle.getString("logo");
            int resID = res.getIdentifier(mDrawableName , "drawable", getActivity().getPackageName());
            e.setImageResource(resID);
            TextView enm=(TextView)view.findViewById(R.id.event_name);
            enm.setText(bundle.getString("ename"));
            TextView tagln=(TextView)view.findViewById(R.id.tagline);
            tagln.setText(bundle.getString("tagline"));
